...
export type Unnamed_8_Query = (
  ...
  & { page404s?: Maybe<Array<Maybe<(
    { __typename?: 'Page404' }
    & Pick<Page404, 'id' | 'language' | 'heading' | 'description' | 'link'>
    & { image?: Maybe<(
      { __typename?: 'UploadFile' }
      & Pick<UploadFile, 'url' | 'alternativeText'>
    )> }
