...
export type Unnamed_1_Query = (
  ...
  & { aboutuses?: Maybe<Array<Maybe<(
    { __typename?: 'AboutUs' }
    & Pick<AboutUs, 'id' | 'language' | 'heroDescription'>
  )>>> }
);
