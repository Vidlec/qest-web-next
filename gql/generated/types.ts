...
export type AboutUsGroupBy = {
	...
	heroHeadlineBottom?: Maybe<
		Array<Maybe<AboutUsConnectionHeroHeadlineBottom>>
	>
	...
	technologiesDescription?: Maybe<
		Array<Maybe<AboutUsConnectionTechnologiesDescription>>
	>
	...
	hqWeAreHereDescription?: Maybe<
		Array<Maybe<AboutUsConnectionHqWeAreHereDescription>>
	>
...
export type CareerOfferingsGroupBy = {
	...
	careerTechnologiesTitle?: Maybe<
		Array<Maybe<CareerOfferingsConnectionCareerTechnologiesTitle>>
	>
	careerTechnologiesContent?: Maybe<
		Array<Maybe<CareerOfferingsConnectionCareerTechnologiesContent>>
	>
	careerExpectedSkillsTitle?: Maybe<
		Array<Maybe<CareerOfferingsConnectionCareerExpectedSkillsTitle>>
	>
	careerExpectedSkillsContent?: Maybe<
		Array<Maybe<CareerOfferingsConnectionCareerExpectedSkillsContent>>
	>
	careerOfferTitle?: Maybe<
		Array<Maybe<CareerOfferingsConnectionCareerOfferTitle>>
	>
	careerOfferContent?: Maybe<
		Array<Maybe<CareerOfferingsConnectionCareerOfferContent>>
	>
...
export type ContactGroupBy = {
	...
	formInvalidEmailWarning?: Maybe<
		Array<Maybe<ContactConnectionFormInvalidEmailWarning>>
	>
...
export type EditHqGalleryInput = {
	galleryCollection?: Maybe<
		Array<Maybe<EditComponentContentGalleryImageInput>>
	>
	published_at?: Maybe<Scalars['DateTime']>
	created_by?: Maybe<Scalars['ID']>
	updated_by?: Maybe<Scalars['ID']>
...
export type JobGroupBy = {
	...
	careerTechnologiesTitle?: Maybe<
		Array<Maybe<JobConnectionCareerTechnologiesTitle>>
	>
	careerTechnologiesContent?: Maybe<
		Array<Maybe<JobConnectionCareerTechnologiesContent>>
	>
	careerExpectedSkills?: Maybe<
		Array<Maybe<JobConnectionCareerExpectedSkills>>
	>
	careerExpectedSkillsContent?: Maybe<
		Array<Maybe<JobConnectionCareerExpectedSkillsContent>>
	>
...
export type Morph =
	...
	| AboutUsGroupBy
	| AboutUsConnectionId
	| AboutUsConnectionCreated_At
	| AboutUsConnectionUpdated_At
	| AboutUsConnectionLanguage
	| AboutUsConnectionHeroDescription
	| AboutUsConnectionHeroLogo
	| AboutUsConnectionHeroHeadlineTop
	| AboutUsConnectionHeroHeadlineBottom
	| AboutUsConnectionHeroArrowTitle
	| AboutUsConnectionWeAreHeadline
	| AboutUsConnectionWeAreDescription
	| AboutUsConnectionWeAreArrowTitle
	| AboutUsConnectionSkillsHeadline
	| AboutUsConnectionSkillsDescription
	| AboutUsConnectionTechnologiesDescription
	| AboutUsConnectionTechnologiesImage
	| AboutUsConnectionValuesHeadline
	| AboutUsConnectionTeamHeadline
	| AboutUsConnectionHqHeadline
	| AboutUsConnectionCareerHeadline
	| AboutUsConnectionCareerCtaTitle
	| AboutUsConnectionCareerCtaImage
	| AboutUsConnectionBlogHeadline
	| AboutUsConnectionHqDescription
	| AboutUsConnectionCareerDescription
	...
	| AboutUsConnectionPublished_At
	| CreateAboutUsPayload
	| UpdateAboutUsPayload
	| DeleteAboutUsPayload
	| AboutWeAreImageCarousel
	| UpdateAboutWeAreImageCarouselPayload
	| DeleteAboutWeAreImageCarouselPayload
	| BrandValue
	| BrandValueConnection
	| BrandValueAggregator
	| BrandValueAggregatorSum
	| BrandValueAggregatorAvg
	| BrandValueAggregatorMin
	| BrandValueAggregatorMax
	| BrandValueGroupBy
	| BrandValueConnectionId
	| BrandValueConnectionCreated_At
	| BrandValueConnectionUpdated_At
	| BrandValueConnectionHeadline
	| BrandValueConnectionBackgroundNumber
	| BrandValueConnectionImage
	| BrandValueConnectionDescription
	| BrandValueConnectionPublished_At
	| CreateBrandValuePayload
	| UpdateBrandValuePayload
	| DeleteBrandValuePayload
	| CareerOfferings
	| CareerOfferingsConnection
	| CareerOfferingsAggregator
	| CareerOfferingsGroupBy
	| CareerOfferingsConnectionId
	| CareerOfferingsConnectionCreated_At
	| CareerOfferingsConnectionUpdated_At
	| CareerOfferingsConnectionLanguage
	| CareerOfferingsConnectionTitle
	| CareerOfferingsConnectionDescription
	| CareerOfferingsConnectionCareerTechnologiesTitle
	| CareerOfferingsConnectionCareerTechnologiesContent
	| CareerOfferingsConnectionCareerExpectedSkillsTitle
	| CareerOfferingsConnectionCareerExpectedSkillsContent
	| CareerOfferingsConnectionCareerOfferTitle
	| CareerOfferingsConnectionCareerOfferContent
	| CareerOfferingsConnectionEndTitle
	| CareerOfferingsConnectionEndContent
	| CareerOfferingsConnectionEndCta
	| CareerOfferingsConnectionSlug
	| CareerOfferingsConnectionColor
	| CareerOfferingsConnectionPerex
	| CareerOfferingsConnectionPublished_At
	| CreateCareerOfferingPayload
	| UpdateCareerOfferingPayload
	| DeleteCareerOfferingPayload
	| Career
	| UpdateCareerPayload
	| DeleteCareerPayload
	| CaseStudyMeta
	...
	| CaseStudyConnection
	| CaseStudyAggregator
	| CaseStudyAggregatorSum
	| CaseStudyAggregatorAvg
	| CaseStudyAggregatorMin
	| CaseStudyAggregatorMax
	| CaseStudyGroupBy
	...
	| ContactConnectionFormName
	| ContactConnectionFormText
	| ContactConnectionFormEmail
	| ContactConnectionFormNameWarning
	| ContactConnectionFormEmailWarning
	| ContactConnectionFormSubmit
	| ContactConnectionFormInvalidEmailWarning
	| ContactConnectionFormTextLabel
	| ContactConnectionFormNameLabel
	| ContactConnectionFormEmailLabel
	| ContactConnectionFooterImg
	...
	| DeleteHeaderPayload
	| HomepageNew
	| UpdateHomepageNewPayload
	| DeleteHomepageNewPayload
	| Homepage
	| HomepageConnection
	| HomepageAggregator
	| HomepageGroupBy
	...
	| HqGalleryAggregator
	| HqGalleryGroupBy
	| HqGalleryConnectionId
	| HqGalleryConnectionCreated_At
	| HqGalleryConnectionUpdated_At
	| HqGalleryConnectionPublished_At
	| CreateHqGalleryPayload
	| UpdateHqGalleryPayload
	...
	| JobGroupBy
	| JobConnectionId
	| JobConnectionCreated_At
	| JobConnectionUpdated_At
	| JobConnectionTitle
	| JobConnectionDescription
	| JobConnectionCareerTechnologiesTitle
	| JobConnectionCareerTechnologiesContent
	| JobConnectionCareerExpectedSkills
	| JobConnectionCareerExpectedSkillsContent
	| JobConnectionCareerOfferTitle
	| JobConnectionCareerOfferContent
	| JobConnectionEndTitle
	| JobConnectionEndContent
	| JobConnectionEndCta
	| JobConnectionLanguage
	| JobConnectionSlug
	| JobConnectionPublished_At
	| CreateJobPayload
	| UpdateJobPayload
	| DeleteJobPayload
	| Language
	...
	| Page404GroupBy
	| Page404ConnectionId
	| Page404ConnectionCreated_At
	| Page404ConnectionUpdated_At
	| Page404ConnectionImage
	| Page404ConnectionHeading
	| Page404ConnectionDescription
	| Page404ConnectionLink
	| Page404ConnectionLanguage
	| Page404ConnectionBgText
	| Page404ConnectionPublished_At
	| CreatePage404Payload
	| UpdatePage404Payload
	| DeletePage404Payload
	| Products
	| ProductsConnection
	| ProductsAggregator
	| ProductsGroupBy
	...
	| ProductsConnectionSlug
	| ProductsConnectionLocale
	...
	| SkillGroupBy
	| SkillConnectionId
	| SkillConnectionCreated_At
	| SkillConnectionUpdated_At
	| SkillConnectionTitle
	| SkillConnectionDescription
	| SkillConnectionTitleColorHash
	| SkillConnectionPublished_At
	| CreateSkillPayload
	| UpdateSkillPayload
	| DeleteSkillPayload
	| SocialNetwork
			...
			Maybe<
				...
				> & {
						...
						careerCTAImage?: Maybe<
							...
							>
						>
						weAreImageCarousel?: Maybe<
							Array<
								Maybe<
									{ __typename?: 'UploadFile' } & Pick<
										UploadFile,
										'id' | 'url' | 'alternativeText'
									>
								>
							>
						>
...
export type CareerOfferQuery = { __typename?: 'Query' } & {
	careerOfferings?: Maybe<
		Array<
			Maybe<
				{ __typename?: 'CareerOfferings' } & Pick<
					CareerOfferings,
					| 'id'
					| 'language'
					| 'title'
...
export type HqGalleriesQuery = { __typename?: 'Query' } & {
	hqGalleries?: Maybe<
		Array<
			Maybe<
				{ __typename?: 'HqGallery' } & {
