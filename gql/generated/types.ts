...
export type Unnamed_2_Query = (
  ...
  & { careers?: Maybe<Array<Maybe<(
    { __typename?: 'Career' }
    & Pick<Career, 'id' | 'language' | 'title' | 'technologiesHeading' | 'technologies' | 'careerDescription' | 'somethingElseHeading' | 'somethingElseDescription' | 'somethingElseContact'>
  )>>> }
);
