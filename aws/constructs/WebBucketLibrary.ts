...
import { AllowedMethods, Distribution, PriceClass, ViewerProtocolPolicy } from '@aws-cdk/aws-cloudfront'
...
export class WebBucketLibrary extends Construct {
    ...
    public constructor(scope: Construct, id: string, props: WebBucketLibraryProps) {
        ...
        this.cdnBaseUrl = `https://${props?.cdnCustomDomain?.domainName ?? distribution.distributionDomainName}`
    }
}
