...
const RichText: React.FC<Props> = ({ richText }) => {
	...
	return (
		<RichTextContainer>
			...
			{desciption && (
				<RichTextDescription>{desciption}</RichTextDescription>
			)}
			{desciptionLevel2 && (
				<RichTextDescription>{desciptionLevel2}</RichTextDescription>
			)}
			{desciptionLevel3 && (
				<RichTextDescription>{desciptionLevel3}</RichTextDescription>
			)}
		</RichTextContainer>
	)
}
