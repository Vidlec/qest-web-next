...
import { Input, Label, LabelSpan, Row, Submit, TextArea, WarningMessage, Wrapper } from './styled'
...
export const Form: React.FC = () => {
  ...
  const shouldDisplayEmailError = !emailStatus.isValid && emailStatus.isTouched
  ...
  return (
    <Container>
      <Wrapper onSubmit={handleSubmit}>
        ...
        <TextArea id="textInput" value={textAreaInput} onChange={handleTextChange} />
        <Row>
          <Label>
            ...
            {shouldDisplayNameError ? (
              <WarningMessage>{t('contact.formNameWarning')}</WarningMessage>
            ) : null}
          </Label>
          <Label>
            ...
            />
            {shouldDisplayEmailError ? <WarningMessage>{emailError}</WarningMessage> : null}
          </Label>
          <Submit type="submit" value={t('contact.formSubmit') as string} disabled={isSending} />
        </Row>
      </Wrapper>
    </Container>
  )
