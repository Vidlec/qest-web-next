...
export type CaseStudy = {
  ...
  readonly content?: Maybe<ReadonlyArray<Maybe<CaseStudyContentDynamicZone>>>;
...
export type CaseStudyGroupBy = {
  ...
  readonly subtitle?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionSubtitle>>>;
  readonly about?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionAbout>>>;
  readonly industry?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionIndustry>>>;
  readonly client?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionClient>>>;
  readonly system?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionSystem>>>;
  readonly mainImage?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionMainImage>>>;
  readonly language?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionLanguage>>>;
  readonly projectId?: Maybe<ReadonlyArray<Maybe<CaseStudyConnectionProjectId>>>;
...
export type CaseStudyInput = {
  ...
  readonly client?: Maybe<Scalars['String']>;
  readonly system?: Maybe<Scalars['String']>;
  readonly mainImage?: Maybe<Scalars['ID']>;
  readonly content?: Maybe<ReadonlyArray<Scalars['CaseStudyContentDynamicZoneInput']>>;
  readonly language: Scalars['String'];
  readonly projectId: Scalars['String'];
  readonly published_at?: Maybe<Scalars['DateTime']>;
  readonly created_by?: Maybe<Scalars['ID']>;
...
export type Unnamed_1_Query = { readonly aboutuses?: Maybe<ReadonlyArray<Maybe<(
    ...
    )>>>, readonly hqImageGrid?: Maybe<ReadonlyArray<Maybe<Pick<UploadFile, 'id' | 'url' | 'alternativeText'>>>>, readonly hqWeAreHereImage?: Maybe<Pick<UploadFile, 'id' | 'url' | 'alternativeText'>> }
  )>>> };

export type Unnamed_2_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_2_Query = { readonly contacts?: Maybe<ReadonlyArray<Maybe<Pick<Contact, 'id' | 'language' | 'title' | 'address' | 'taxIdentificationNumbers' | 'taxIdentificationDescription' | 'email' | 'phoneNumber'>>>> };
...
export type FooterQuery = { readonly footer?: Maybe<(
    Pick<Footer, 'title'>
    & { readonly contact?: Maybe<Pick<ComponentContentContact, 'address' | 'phoneNumber' | 'email' | 'ico' | 'dic' | 'legal'>>, readonly social?: Maybe<Pick<ComponentContentSocial, 'facebook' | 'linkedIn' | 'instagram' | 'twitter'>> }
  )> };

export type Unnamed_3_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_3_Query = { readonly headers?: Maybe<ReadonlyArray<Maybe<(
    Pick<Header, 'id' | 'language' | 'title' | 'description'>
    & { readonly logo?: Maybe<Pick<UploadFile, 'url'>> }
  )>>> };

export type InternalLinkFragmentFragment = Pick<ComponentNavigationInternalLink, 'label' | 'path'>;
...
export type HomePageQuery = { readonly homepageNew?: Maybe<(
    Pick<HomepageNew, 'id' | 'clickToStopText' | 'aboveLineText' | 'belowLineText'>
    & { readonly topLeftLink?: Maybe<InternalLinkFragmentFragment>, readonly topRightLink?: Maybe<InternalLinkFragmentFragment>, readonly bottomLeftLink?: Maybe<InternalLinkFragmentFragment>, readonly bottomRightLink?: Maybe<InternalLinkFragmentFragment>, readonly logo?: Maybe<Pick<UploadFile, 'url'>> }
  )> };

export type Unnamed_4_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_4_Query = { readonly homepages?: Maybe<ReadonlyArray<Maybe<(
...
export type LanguagesQuery = { readonly languages?: Maybe<ReadonlyArray<Maybe<Pick<Language, 'id' | 'languageCode' | 'displayName'>>>> };

export type Unnamed_5_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_5_Query = { readonly menus?: Maybe<ReadonlyArray<Maybe<Pick<Menu, 'id' | 'aboutUs' | 'career' | 'contact' | 'homePage' | 'language' | 'menu' | 'reference'>>>> };
...
export type ProductQuery = { readonly product?: Maybe<Pick<Products, 'id' | 'name' | 'locale'>> };
...
export type ProductsQuery = { readonly products?: Maybe<ReadonlyArray<Maybe<Pick<Products, 'id' | 'name' | 'locale'>>>> };

export type Unnamed_6_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_6_Query = { readonly socialNetworks?: Maybe<ReadonlyArray<Maybe<Pick<SocialNetwork, 'id' | 'name' | 'url'>>>> };
